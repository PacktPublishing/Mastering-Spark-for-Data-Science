...
object createAvro {
  def main(args: Array[String]) {
    ...
    val inputFile = new File("/Users/uktpmhallett/Downloads/20160101020000.gkg.csv")
    val outputFile = new File("/Users/uktpmhallett/Downloads/20160101020000.gkg.avro")
